            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('user.add')
                            <p class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#create-fabric-quality">
                    ...
                    <div class="card-body">
                        ...
                        <table id="dataTable" class="table table-bordered table-striped dataTable dtr-inline table-responsive-lg"
                            ...
                            <tbody>
                                @foreach ($fabric_qualitys as $fab)
                                    <tr>
                                        <td class="text-center">
                                            @can('user.delete')
                                                <div class="btn-group">
                                                    <form action="{{ route('delete-fabric-quality', ['id' => $fab->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
