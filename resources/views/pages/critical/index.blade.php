...
@endphp --}}
                    @foreach ($criticalPath as $data)
                        <tr>
                            ...
                            <th>
                                <a href="{{ asset($data->image) }}" target="_blank">{{ $edit_file_name }}</a>
                                @php
                                    if($data->image == null){
                                        @endphp

                                        <input class="image_general_info" id="image_general_info" type="file"
                                        value="{{ $data->image }}" name="image_general_info"
                                        data-c-id={{ $data->c_id }} />


                                        <button class="image_general_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            {{-- <th><a href="{{ asset($data->image) }}" target="_blank">{{ $edit_file_name }}</a></th> --}}
                            <th>
                            ...
                            <th style="background-color: <?php echo empty($data->lab_dip_image) ? 'red' : 'transparent'; ?>">
                                ...
                                <a href="{{ asset($data->lab_dip_image) }}"
                                    ...
                                    @php
                                    if($data->lab_dip_image == null){
                                        @endphp

                                        <input class="image_labdip_info" id="image_labdip_info" type="file"
                                        value="{{ $data->lab_dip_image }}" name="image_labdip_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_labdip_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->embellishment_s_o_image) ? 'red' : 'transparent'; ?>">
                                ...
                                {{-- <a href="{{ asset($data->embellishment_s_o_image) }}"
                                    target="_blank">{{ $embellishment_s_o_image_name }}</a> --}}
                                    <a href="{{ asset($data->embellishment_s_o_image) }}" target="_blank">{{ $embellishment_s_o_image_name }}</a>

                                    @php
                                        if($data->embellishment_s_o_image == null){
                                            @endphp

                                            <input class="image_embellishment_info" id="image_embellishment_info" type="file"
                                            value="{{ $data->embellishment_s_o_image }}" name="image_embellishment_info"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_embellishment_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->bulk_fabric_knit_down_image) ? 'red' : 'transparent'; ?>">
                                @php
                                    $bulk_fabric_knit_down_image_name = substr($data->bulk_fabric_knit_down_image, 14);
                                @endphp
                                <a href="{{ asset($data->bulk_fabric_knit_down_image) }}" target="_blank">{{ $bulk_fabric_knit_down_image_name }}</a>

                                @php
                                    if($data->bulk_fabric_knit_down_image == null){
                                        @endphp

                                        <input class="image_bulk_info" id="image_bulk_info" type="file"
                                        value="{{ $data->bulk_fabric_knit_down_image }}" name="image_bulk_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_bulk_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->development_photo_sample_dispatch_sample_image) ? 'red' : 'transparent'; ?>">
                                {{-- <a href="{{ asset($data->development_photo_sample_dispatch_sample_image) }}"
                                    target="_blank">{{ $edit_dev_photo }}</a> --}}
                                <a href="{{ asset($data->development_photo_sample_dispatch_sample_image) }}" target="_blank">{{ $edit_dev_photo }}</a>

                                    @php
                                        if($data->development_photo_sample_dispatch_sample_image == null){
                                            @endphp

                                            <input class="image_development_info" id="image_development_info" type="file"
                                            value="{{ $data->development_photo_sample_dispatch_sample_image }}" name="cc"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_development_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->fit_sample_image) ? 'red' : 'transparent'; ?>">
                                {{-- <a href="{{ asset($data->fit_sample_image) }}"
                                    target="_blank">{{ $fit_sample_name }}</a> --}}
                                <a href="{{ asset($data->fit_sample_image) }}" target="_blank">{{ $fit_sample_name }}</a>

                                    @php
                                        if($data->fit_sample_image == null){
                                            @endphp

                                            <input class="image_fit_info" id="image_fit_info" type="file"
                                            value="{{ $data->fit_sample_image }}" name="image_fit_info"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_fit_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->size_set_image) ? 'red' : 'transparent'; ?>">
                                ...
                                {{-- <a href="{{ asset($data->size_set_image) }}"
                                    target="_blank">{{ $size_set_image_file_name }}</a> --}}
                                    <a href="{{ asset($data->size_set_image) }}" target="_blank">{{ $size_set_image_file_name }}</a>

                                    @php
                                        if($data->size_set_image == null){
                                            @endphp

                                            <input class="image_size_info" id="image_size_info" type="file"
                                            value="{{ $data->size_set_image }}" name="image_size_info"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_size_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->pp_sample_image) ? 'red' : 'transparent'; ?>">
                                ...
                                {{-- <a href="{{ asset($data->pp_sample_image) }}"
                                    target="_blank">{{ $pp_sample_image_file_name }}</a> --}}
                                    <a href="{{ asset($data->pp_sample_image) }}" target="_blank">{{ $pp_sample_image_file_name }}</a>

                                    @php
                                        if($data->pp_sample_image == null){
                                            @endphp

                                            <input class="image_pp_sample_info" id="image_pp_sample_info" type="file"
                                            value="{{ $data->pp_sample_image }}" name="image_pp_sample_info"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_pp_sample_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th style="background-color: <?php echo empty($data->pp_meeting_report_upload) ? 'red' : 'transparent'; ?>">
                                ...
                                {{-- <a href="{{ asset($data->pp_meeting_report_upload) }}"
                                    ...
                                    @php
                                        if($data->pp_meeting_report_upload == null){
                                            @endphp

                                            <input class="image_pp_meeting_info" id="image_pp_meeting_info" type="file"
                                            value="{{ $data->pp_meeting_report_upload }}" name="image_pp_meeting_info"
                                            data-c-id={{ $data->c_id }} />

                                            <button class="image_pp_meeting_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>
                                ...
                                {{-- <a href="{{ asset($data->sewing_inline_inspection_report_upload) }}"
                                    target="_blank">{{ $sew_file_edit_file_name }}</a> --}}
                                    <a href="{{ asset($data->sewing_inline_inspection_report_upload) }}" target="_blank">{{ $sew_file_edit_file_name }}</a>

                                @php
                                    if($data->sewing_inline_inspection_report_upload == null){
                                        @endphp

                                        <input class="image_sewing_info" id="image_sewing_info" type="file"
                                        value="{{ $data->sewing_inline_inspection_report_upload }}" name="image_sewing_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_sewing_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>
                                <a href="{{ asset($data->finishing_inline_inspection_report) }}" target="_blank">{{ $finish_inline_file_edit_file_name }}</a>

                                @php
                                    if($data->finishing_inline_inspection_report == null){
                                        @endphp

                                        <input class="image_finish_info" id="image_finish_info" type="file"
                                        value="{{ $data->finishing_inline_inspection_report }}" name="image_finish_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_finish_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>
                                <a href="{{ asset($data->pre_final_aql_report_schedule) }}" target="_blank">{{ $pre_final_aql_report_edit_file_name }}</a>

                                @php
                                    if($data->pre_final_aql_report_schedule == null){
                                        @endphp

                                        <input class="image_pre_final_info" id="image_pre_final_info" type="file"
                                        value="{{ $data->pre_final_aql_report_schedule }}" name="image_pre_final_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_pre_final_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>
                                <a href="{{ asset($data->final_aql_report_upload) }}" target="_blank">{{ $final_aql_file_edit_file_name }}</a>

                                @php
                                    if($data->final_aql_report_upload == null){
                                        @endphp

                                        <input class="image_final_aql_info" id="image_final_aql_info" type="file"
                                        value="{{ $data->final_aql_report_upload }}" name="image_final_aql_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_final_aql_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>
                                <a href="{{ asset($data->production_sample_upload) }}" target="_blank">{{ $pp_sam_img_edit_file_name }}</a>

                                @php
                                    if($data->production_sample_upload == null){
                                        @endphp

                                        <input class="image_production_info" id="image_production_info" type="file"
                                        value="{{ $data->production_sample_upload }}" name="image_production_info"
                                        data-c-id={{ $data->c_id }} />

                                        <button class="image_production_info_submit_button btn btn-success btn-sm">Submit</button>
                            ...
                            <th>{{ change_date_formate($data->ex_factory_date )}}</th>
...
<script>
    $(document).ready(function() {
        ...
        $(".image_general_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_general_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_general_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_general_info');
        ...
        $(".image_labdip_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_labdip_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_labdip_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_labdip_info');
        ...
        $(".image_embellishment_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_embellishment_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_embellishment_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_embellishment_info');
        ...
        $(".image_bulk_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_bulk_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_bulk_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_bulk_info');
        ...
        $(".image_development_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_development_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_development_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_development_info');
        ...
        $(".image_fit_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_fit_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_fit_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_fit_info');
        ...
        $(".image_size_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_size_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_size_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_size_info');
        ...
        $(".image_pp_sample_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_pp_sample_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_pp_sample_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_pp_sample_info');
        ...
        $(".image_pp_meeting_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_pp_meeting_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_pp_meeting_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_pp_meeting_info');
        ...
        $(".image_sewing_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_sewing_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_sewing_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_sewing_info');
        ...
        $(".image_finish_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_finish_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_finish_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_finish_info');
        ...
        $(".image_pre_final_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_pre_final_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_pre_final_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_pre_final_info');
        ...
        $(".image_final_aql_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_final_aql_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_final_aql_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_final_aql_info');
        ...
        $(".image_production_info_submit_button").on("click", function() {
            // Get the hidden po_id value
            var po_id = $(".image_production_info").data('c-id');

            // Create a FormData object to handle the file upload
            var formData = new FormData();
            formData.append('image', $(".image_production_info")[0].files[0]);
            formData.append('_token', '{{ csrf_token() }}');
            formData.append('po_id', po_id);
            formData.append('type', 'image_production_info');
